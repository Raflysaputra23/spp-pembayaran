		<section class="p-5 md:p-10 lg:p-15 overflow-y-auto overflow-x-hidden">
			...
			<form id="Manual-form" action="<?=Constant::DIRNAME?>register/registerSingleUser" class="container max-w-[400px] rounded-md shadow-lg m-auto p-4 hidden dark:bg-slate-800" method="post" autocomplete="off">
				...
				<div class="form-group dark:text-slate-200 mt-6 my-4 poppins">
			...
			<form id="Admin-form" action="<?=Constant::DIRNAME?>register/registerSingleAdmin" class="container max-w-[400px] rounded-md shadow-lg m-auto p-4 dark:bg-slate-800" method="post" autocomplete="off">
				<h1 class="text-center text-4xl tillana text-shadow text-red-500 mb-10">Register</h1>
				<div class="form-group dark:text-slate-200 mt-6 poppins relative">
