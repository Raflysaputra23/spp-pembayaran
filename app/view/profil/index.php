		<section class="p-5 md:p-10 lg:p-15 overflow-y-auto overflow-x-hidden">
            ...
            <form id="form-profil" action="<?=Constant::DIRNAME?>profil/setProfil/<?=$_SESSION["Role"]?>" class="grid grid-cols-[1fr] lg:grid-cols-[350px_1fr] my-8 gap-8 items-center" method="post" enctype="multipart/form-data">
				<div class="w-[60%] md:w-[50%] lg:w-[80%] mx-auto relative">
					<img id="plate-foto" src="<?=Constant::DIRNAME?>img/<?=$data["dataUser"]["Foto"]?>" alt="" class="aspect-[3/4] shadow rounded-md border dark:border-slate-200">
				...
				<div class="poppins">
					...
					<div class="md:flex md:gap-4 md:items-center">
						<div class="form-group mb-4 w-[100%] dark:text-slate-200">
					...
					<div class="flex gap-4 items-center">
						...
						<div class="form-group mb-4 w-[100%] dark:text-slate-200">
							...
							<select name="jenkel" id="jenkel" class="control-input p-2 px-3 border-slate-300 dark:bg-slate-900" required>
								<option value="Null" <?=($data["dataUser"]["Jenkel"] == "Null") ? "selected" : ""?>></option>
			...
			<section data-modal-static="off" class="hidden dark:bg-slate-800 dark:text-slate-200">
				<div id="modalBox1" data-modal-size="400" class="poppins dark:bg-slate-800 dark:text-slate-200" style="width: 500px">
